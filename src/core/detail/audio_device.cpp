...
int32_t AudioDevice::SetPlayoutDevice(uint16_t index) { return 0; }

int32_t AudioDevice::SetPlayoutDevice(WindowsDeviceType device) { return 0; }
...
bool AudioDevice::PlayoutIsInitialized() const { return false; }
...
bool AudioDevice::SpeakerIsInitialized() const { return false; }

int32_t AudioDevice::InitMicrophone() { return 0; }

bool AudioDevice::MicrophoneIsInitialized() const { return false; }

int32_t AudioDevice::SpeakerVolumeIsAvailable(bool* available) { return 0; }
...
int32_t AudioDevice::MinSpeakerVolume(uint32_t* minVolume) const { return 0; }
...
int32_t AudioDevice::SpeakerMuteIsAvailable(bool* available) { return 0; }

int32_t AudioDevice::SetSpeakerMute(bool enable) { return 0; }

int32_t AudioDevice::SpeakerMute(bool* enabled) const { return 0; }
...
int32_t AudioDevice::StereoPlayout(bool* enabled) const { return 0; }
